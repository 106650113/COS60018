...
pt_dict ={} # creates and empty list so that each patient that is created in the pt_reg function can be accessed outside of the function
tests_dict = {}
specimen_list_dict = {}
...
def user_guide():#Function for navigating the user to the menu option that they have chosen
    ...
    else: #if the user enters a number that is not present they will be prompted to choose a menu item from 1-4. As there is a while loop this will continue until the user enters an acceptable option 
...
def pt_reg():# This function will create patient profiles which will later be used to register tests under
    while True:
...
def test_reg():
    while True: #while True code is used to allow the user to register tests for multiple patients
        ...
        if ur in pt_dict: #This if statement will check to see whether the patient exists within the program.
                ...
                #In this for statement I am are asking what type of specimen the user has recieved and  what tests have been ordered for it
                ...
                for specimens in range(specimen_num):
                    ...
                    #These boolean statements provide the user with instruction of what to do with each possible outcome.
                ...
                #The following boolean statements allow for the user to enter another patient or to return to the main menu
        ...
        else: #if the patient does not exist in the program the user will be prompted to complete patient registration and the pt_reg() function is called.
...
def search(): #function to search registered patients
    ...
    if ur in specimen_list_dict: #checking what specimens have been collected for this patient
